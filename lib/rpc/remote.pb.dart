...
class QueryMeta extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryMeta', createEmptyInstance: create)
    ...
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'start', $pb.PbFieldType.OU3)
  ...
  factory QueryMeta.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory QueryMeta.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryMeta clone() => QueryMeta()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryMeta copyWith(void Function(QueryMeta) updates) => super.copyWith((message) => updates(message as QueryMeta)) as QueryMeta; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryMeta create() => QueryMeta._();
  QueryMeta createEmptyInstance() => create();
  static $pb.PbList<QueryMeta> createRepeated() => $pb.PbList<QueryMeta>();
  @$core.pragma('dart2js:noInline')
  static QueryMeta getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryMeta>(create);
  ...
  @$pb.TagNumber(3)
  set start($core.int v) { $_setUnsignedInt32(2, v); }
  @$pb.TagNumber(3)
...
class Data extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Data', createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'code', $pb.PbFieldType.O3)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message')
    ..pc<Record>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'records', $pb.PbFieldType.PM, subBuilder: Record.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.List<Record> get records => $_getList(2);
}
